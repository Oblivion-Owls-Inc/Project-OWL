...
//-----------------------------------------------------------------------------
    ...
    /// @param  stream  the json data to read from
    void readValue( nlohmann::json const& data );

    /// @brief  reads the derivative of this ControlPoint
    /// @param  stream  the json data to read from
    void readDerivative( nlohmann::json const& data );
...
//-----------------------------------------------------------------------------
    ...
    /// @param  stream  the json data to read from
    void readInterpolationType( nlohmann::json const& data );
    ...
    /// @param  stream  the json data to read from
    void readControlPoints( nlohmann::json const& data );
