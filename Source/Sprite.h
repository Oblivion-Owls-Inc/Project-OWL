...
//-----------------------------------------------------------------------------
    ...
    void readTexture( nlohmann::json const& data );
    ...
    void readColor( nlohmann::json const& data );

    /// @brief  Read in the opacity for a sprite.
    /// @param  stream  The json to read from.
    void readOpacity( nlohmann::json const& data );

    /// @brief  Read in the layer for a sprite.
    /// @param  stream  The json to read from.
    void readLayer( nlohmann::json const& data );
