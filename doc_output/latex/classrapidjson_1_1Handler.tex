\hypertarget{classrapidjson_1_1Handler}{}\doxysection{Handler Class Reference}
\label{classrapidjson_1_1Handler}\index{Handler@{Handler}}


Concept for receiving events from \mbox{\hyperlink{classGenericReader}{Generic\+Reader}} upon parsing. The functions return true if no error occurs. If they return false, the event publisher should terminate the process.  
...
\begin{DoxyCode}{0}
\DoxyCodeLine{concept \mbox{\hyperlink{classrapidjson_1_1Handler}{Handler}} \{}
