\hypertarget{classEncodedOutputStream}{}\doxysection{Encoded\+Output\+Stream$<$ Encoding, Output\+Byte\+Stream $>$ Class Template Reference}
\label{classEncodedOutputStream}\index{EncodedOutputStream$<$ Encoding, OutputByteStream $>$@{EncodedOutputStream$<$ Encoding, OutputByteStream $>$}}
...
\hline
{\em Output\+Byte\+Stream} & Type of input byte stream. For example, \mbox{\hyperlink{classFileWriteStream}{File\+Write\+Stream}}. \\
\hline
\end{DoxyTemplParams}
